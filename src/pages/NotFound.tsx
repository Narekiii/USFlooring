...
export default function NotFound() {
  return (
    <div className="pb-[72px] lg:pb-0">
      ...
      />
      <section className="pt-40 pb-24 bg-subtle min-h-[70vh] flex items-center">
        <div className="max-w-[640px] mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
            <Link to="/" className="bg-red text-white px-7 py-4 rounded-[2px] font-sans text-[15px] font-bold hover:bg-red-dark transition-colors">
              Back to Homepage
            </Link>
            <Link to="/contact" className="border-[1.5px] border-charcoal text-charcoal px-7 py-4 rounded-[2px] font-sans text-[15px] font-bold hover:bg-subtle/60 transition-colors">
