          ...
          <div className="bg-cream border border-divider rounded-[3px] p-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex gap-3 flex-wrap">
                <a href="https://www.google.com/maps/dir/?api=1&destination=1508+W+Burbank+Blvd+Burbank+CA+91506" target="_blank" rel="noopener noreferrer" className="bg-charcoal text-warm-white px-6 py-3 rounded-[2px] font-sans text-[13px] font-semibold hover:bg-espresso transition-colors">Get Directions</a>
                <a href="tel:+18185150009" className="border-[1.5px] border-charcoal text-charcoal px-6 py-3 rounded-[2px] font-sans text-[13px] font-semibold hover:bg-cream transition-colors">Call (818) 515-0009</a>
              </div>
            </div>
