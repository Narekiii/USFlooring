    ...
    <div className="pb-[72px] lg:pb-0">
      ...
      <section className="pt-8 pb-16 bg-subtle">
        <div className="max-w-[1180px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="font-serif text-[40px] lg:text-[54px] font-semibold text-charcoal leading-[1.06] mb-5">Professional Flooring Installation in Burbank</h1>
      ...
      <section className="bg-ivory">
        <div className="max-w-[1180px] mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">{benefits.map((b) => <div key={b.title} className="bg-subtle border border-border rounded-[3px] p-7"><h3 className="font-sans text-[15px] font-semibold text-charcoal mb-3">{b.title}</h3><p className="font-sans text-[13px] text-charcoal/55 leading-relaxed">{b.desc}</p></div>)}</div>
        </div>
      </section>
