...
const items = [{ label: "Home", href: "/" }, { label: "Products & Services", href: "/products" }, { label: "Moldings & Baseboards" }];
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.usflooring.la/molding-baseboard-installation-burbank" },
  openGraph: { title: "Molding & Baseboard Installation in Burbank | US Flooring", description: "Complete molding and baseboard installation from US Flooring & Molding Inc. in Burbank. The finishing detail that makes a floor look complete.", url: "https://www.usflooring.la/molding-baseboard-installation-burbank" },
};
...
export default function MoldingInstallationPage() {
  return (
    <div className="pb-[72px] lg:pb-0">
      ...
      <section className="pt-8 pb-16 bg-subtle">
        <div className="max-w-[1180px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="font-sans text-[11px] font-bold text-walnut uppercase tracking-widest mb-4">Moldings & Baseboards · Burbank, CA</p>
            <h1 className="font-serif text-[40px] lg:text-[54px] font-bold text-charcoal leading-[1.06] mb-5">Molding and Baseboard Installation in Burbank</h1>
            <p className="font-sans text-base lg:text-[17px] text-charcoal/60 leading-relaxed mb-8">The finishing detail that turns an installed floor into a finished room. We carry and install a full line of coordinating moldings — baseboards, transitions, stair nose, and trim — so everything ties together cleanly.</p>
          ...
          <div className="relative overflow-hidden rounded-[3px] aspect-[4/3] bg-subtle/30">
            <Image src="https://images.unsplash.com/photo-1655457397686-4dd23e78a918?w=720&h=540&fit=crop&auto=format" alt="Baseboard and molding trim installation" fill priority sizes="(max-width: 1024px) 100vw, 542px" className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-ivory">
        <div className="max-w-[1180px] mx-auto px-6 py-16">
          <h2 className="font-serif text-[28px] lg:text-[38px] font-bold text-charcoal leading-tight mb-10">Molding Types We Carry and Install</h2>
      ...
      <section className="bg-subtle border-t border-border">
        <div className="max-w-[860px] mx-auto px-6 py-16">
          <h2 className="font-serif text-[28px] lg:text-[38px] font-bold text-charcoal leading-tight mb-10">Moldings & Baseboards FAQ</h2>
      ...
      <section className="bg-charcoal py-16">
        <div className="max-w-[680px] mx-auto px-6 text-center">
          <h2 className="font-serif text-[28px] lg:text-[38px] font-bold text-ivory mb-4">Finish the Job Right</h2>
