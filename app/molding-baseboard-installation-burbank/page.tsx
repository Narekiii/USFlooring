      ...
      <section className="pt-8 pb-16 bg-subtle">
        <div className="max-w-[1180px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative overflow-hidden rounded-[3px] aspect-[4/3] bg-subtle/30">
            <Image src="https://images.unsplash.com/photo-1655457397686-4dd23e78a918?w=720&h=540&fit=crop&auto=format" alt="Baseboard and molding trim installation" fill priority sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
          </div>
        </div>
      </section>
