...
const items = [{ label: "Home", href: "/" }, { label: "Products & Services", href: "/products" }, { label: "Luxury Vinyl Flooring" }];
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.usflooring.la/luxury-vinyl-flooring-burbank" },
  openGraph: { title: "Luxury Vinyl Flooring in Burbank | US Flooring & Molding", description: "Waterproof luxury vinyl plank and tile flooring from a family-owned Burbank flooring store. Professional installation with a 1-year labor guarantee.", url: "https://www.usflooring.la/luxury-vinyl-flooring-burbank" },
};
...
export default function LuxuryVinylFlooringPage() {
  return (
    <div className="pb-[72px] lg:pb-0">
      ...
      <section className="pt-8 pb-16 bg-subtle">
        <div className="max-w-[1180px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="font-sans text-[11px] font-bold text-walnut uppercase tracking-widest mb-4">Luxury Vinyl Flooring · Burbank, CA</p>
            <h1 className="font-serif text-[40px] lg:text-[54px] font-bold text-charcoal leading-[1.06] mb-5">Luxury Vinyl Flooring Sales and Installation in Burbank</h1>
            <p className="font-sans text-base lg:text-[17px] text-charcoal/60 leading-relaxed mb-8">Fully waterproof, comfortable underfoot, and built to handle real life. LVP and LVT are the right answer for kitchens, bathrooms, and busy households with pets or children.</p>
      ...
      <section className="bg-ivory">
        <div className="max-w-[1180px] mx-auto px-6 py-16">
          <h2 className="font-serif text-[28px] lg:text-[38px] font-bold text-charcoal leading-tight mb-10">Why Luxury Vinyl?</h2>
      ...
      <section className="bg-subtle border-t border-border">
        <div className="max-w-[860px] mx-auto px-6 py-16">
          <h2 className="font-serif text-[28px] lg:text-[38px] font-bold text-charcoal leading-tight mb-10">Luxury Vinyl FAQ</h2>
      ...
      <section className="bg-charcoal py-16">
        <div className="max-w-[680px] mx-auto px-6 text-center">
          <h2 className="font-serif text-[28px] lg:text-[38px] font-bold text-ivory mb-4">Compare Vinyl Options at Our Showroom</h2>
