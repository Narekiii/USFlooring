      ...
      <section className="pt-8 pb-16 bg-subtle">
        <div className="max-w-[1180px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="font-serif text-[40px] lg:text-[54px] font-semibold text-charcoal leading-[1.06] mb-5">Luxury Vinyl Flooring Sales and Installation in Burbank</h1>
