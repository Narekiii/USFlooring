...
const items = [{ label: "Home", href: "/" }, { label: "Products & Services", href: "/products" }, { label: "Hardwood Flooring" }];
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.usflooring.la/hardwood-flooring-burbank" },
  openGraph: { title: "Hardwood Flooring in Burbank | US Flooring & Molding", description: "Solid and engineered hardwood flooring from a family-owned Burbank flooring store with over 20 years of installation experience.", url: "https://www.usflooring.la/hardwood-flooring-burbank" },
};
...
const faqs = [
  ...
  { q: "How long does hardwood flooring installation take?", a: "Timeline depends on the square footage, whether the hardwood needs to acclimate, and subfloor condition. We will give you a realistic schedule during the estimate." },
...
const jsonLd = [
  ...
  { "@context": "https://schema.org", "@type": "Service", name: "Hardwood Flooring Sales and Installation", provider: { "@type": "LocalBusiness", name: "US Flooring & Molding Inc.", url: "https://www.usflooring.la/" }, areaServed: { "@type": "City", name: "Burbank" }, description: "Solid and engineered hardwood flooring sales and professional installation serving Burbank and greater Los Angeles." },
