...
function VinylIllustration() {
  return (
    <svg viewBox="0 0 160 96" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-full max-w-[160px]">
      ...
      {/* SPC/WPC core — dot fill to suggest composite */}
      <circle cx="28" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="44" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="60" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="76" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="92" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="108" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="124" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="140" cy="40" r="1.2" fill="#073B7A" />
      <circle cx="28" cy="50" r="1.2" fill="#073B7A" />
      <circle cx="44" cy="50" r="1.2" fill="#073B7A" />
      <circle cx="60" cy="50" r="1.2" fill="#073B7A" />
      <circle cx="76" cy="50" r="1.2" fill="#073B7A" />
      <circle cx="92" cy="50" r="1.2" fill="#073B7A" />
      <circle cx="108" cy="50" r="1.2" fill="#073B7A" />
      <circle cx="124" cy="50" r="1.2" fill="#073B7A" />
      <circle cx="140" cy="50" r="1.2" fill="#073B7A" />
      {/* Underlayment */}
...
function HeroIllustration() {
  return (
    <svg viewBox="0 0 320 160" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-full opacity-70">
      {/* 4 planks shown as thin cross-section slices side by side */}
      {/* Plank 1 — Solid */}
      ...
      <circle cx="255" cy="78" r="1.1" fill="#073B7A" />
      <circle cx="268" cy="78" r="1.1" fill="#073B7A" />
      <circle cx="281" cy="78" r="1.1" fill="#073B7A" />
      <circle cx="294" cy="78" r="1.1" fill="#073B7A" />
      <circle cx="255" cy="92" r="1.1" fill="#073B7A" />
      <circle cx="268" cy="92" r="1.1" fill="#073B7A" />
      <circle cx="281" cy="92" r="1.1" fill="#073B7A" />
      <circle cx="294" cy="92" r="1.1" fill="#073B7A" />
...
const cards = [
  {
    ...
    desc: 'One piece of solid wood, milled from the log. Full-depth grain, and the only option you can sand and refinish multiple times over its life.',
    bestFor: 'Dry, climate-stable rooms',
    facts: ['Refinishable 4–6×', 'Durability: Very High', 'Price: High'],
    Illustration: SolidHardwoodIllustration,
  },
  {
    label: 'LAYERED HARDWOOD',
    title: 'Engineered Wood',
    desc: 'A real hardwood veneer bonded over a cross-layered core. More dimensionally stable than solid wood, and safe over radiant heat and concrete slabs.',
    bestFor: 'Radiant heat & below-grade rooms',
    facts: ['Refinishable up to 3×', 'Durability: High', 'Price: Mid–High'],
    Illustration: EngineeredWoodIllustration,
  },
  {
    label: 'PRINTED WOOD DETAIL',
    title: 'Laminate',
    desc: 'A high-resolution photographic layer of wood grain, sealed under a hard-wearing surface and fused to a dense fiberboard core.',
    bestFor: 'Budget-conscious, high-traffic rooms',
    facts: ['Refinishable: No', 'Durability: Moderate', 'Price: Low'],
    Illustration: LaminateIllustration,
  },
  {
    label: 'FULLY WATERPROOF',
    title: 'Vinyl (LVP / LVT)',
    desc: 'Layered PVC construction, fully waterproof from surface to backing. The most forgiving option for moisture-prone rooms.',
    bestFor: 'Kitchens, bathrooms, basements',
    facts: ['Refinishable: No', 'Durability: Moderate', 'Price: Low–Mid'],
    Illustration: VinylIllustration,
  },
];
...
const tableRows: TableRow[] = [
  {
    label: 'Waterproof',
    cells: [
      { text: 'Not waterproof', type: 'warning' },
      { text: 'Water-resistant', type: 'neutral' },
      { text: 'Not waterproof unless rated', type: 'warning' },
      { text: 'Fully waterproof', type: 'positive' },
    ],
  },
  {
    label: 'Refinishable',
    cells: [
      { text: 'Yes, 4–6×', type: 'positive' },
      { text: 'Limited, up to 3×', type: 'neutral' },
  ...
  },
  {
    label: 'Durability',
    cells: [
      { text: 'Very High', type: 'positive' },
      { text: 'High', type: 'positive' },
      { text: 'Moderate', type: 'neutral' },
      { text: 'Moderate', type: 'neutral' },
    ],
  },
  {
    label: 'Radiant floor heat',
    cells: [
      { text: 'Not recommended', type: 'warning' },
      { text: 'Yes', type: 'positive' },
      { text: 'Most brands', type: 'positive' },
      { text: 'Yes', type: 'positive' },
    ],
  },
  {
    ...
    cells: [
      { text: 'High', type: 'neutral' },
      { text: 'Mid–High', type: 'neutral' },
      { text: 'Low', type: 'neutral' },
      { text: 'Low–Mid', type: 'neutral' },
    ],
  },
  {
    label: 'Best for resale value',
    cells: [
      { text: 'Highest', type: 'positive' },
      { text: 'High', type: 'positive' },
      { text: 'Lower', type: 'neutral' },
      { text: 'Lower–Moderate', type: 'neutral' },
    ],
  },
];
...
const callouts = [
  {
    heading: 'Why engineered wood resists warping',
    body: 'Wood moves far more across the grain than along it. In solid hardwood, every board moves the same direction, so that movement adds up across the floor. Engineered wood layers its core with each grain running perpendicular to the one below — the same logic as plywood — so each layer restrains the next and the finished floor moves dramatically less.',
  },
  {
    heading: 'SPC vs. WPC vinyl cores',
    body: 'SPC (stone plastic composite) is a dense, rigid core — firmer underfoot and highly resistant to furniture dents. WPC (wood plastic composite) uses a foamed core — softer, quieter, and warmer underfoot, but less resistant to concentrated weight like chair legs or heels.',
  },
  {
    heading: 'Installation at a glance',
    body: 'Hardwood is nailed or stapled to a wood subfloor. Engineered wood can be nailed, glued, or floated depending on the subfloor. Laminate almost always floats as a single interlocking layer. Vinyl can float, be glued down, or — in peel-and-stick form — self-adhere directly to the subfloor.',
  },
  {
    heading: 'Maintenance and lifespan',
    body: 'Hardwood and engineered wood need regular sweeping and occasional refinishing to stay ahead of wear. Laminate and vinyl need only sweeping and damp mopping, with no refinishing possible — when the surface wears through, the plank is replaced rather than restored.',
  },
];

const crumbs = [{ label: 'Home', href: '/' }, { label: "Buyer's Guide" }];
    ...
    <td className={`${bg} px-4 py-4 text-[13px] leading-snug border-b border-[#DDD4C6] align-top`}>
      {cell.type === 'positive' && cell.text !== 'No' ? (
        <span className="flex items-start gap-1.5">
          <CheckMark />
          <span className="text-charcoal">{cell.text}</span>
        </span>
      ) : cell.type === 'warning' ? (
  ...
  return (
    <div className="pb-[72px] lg:pb-0">
      <SEO
        ...
        ogDescription="An educational comparison of hardwood, engineered wood, laminate, and vinyl flooring — from a flooring company with 20+ years serving Los Angeles."
        ogUrl="https://www.usflooring.la/buyers-guide"
        jsonLd={jsonLd}
      />
      ...
      <section className="bg-ivory pt-8 pb-20">
        <div className="max-w-[1180px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            <p className="font-sans text-[10px] font-semibold text-walnut uppercase tracking-[0.16em] mb-5">
              Buyer&rsquo;s Guide
            </p>
            <h1 className="font-serif text-[38px] lg:text-[56px] font-bold text-charcoal leading-[1.06] mb-5">
              Find the Right Flooring for Your Property
            </h1>
            <p className="font-sans text-base lg:text-[17px] text-[#111D27] leading-relaxed max-w-[56ch] mb-8">
              Compare hardwood, engineered wood, laminate, and vinyl based on appearance, durability, moisture exposure, maintenance, lifestyle, installation requirements, and budget.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                to="/contact"
                className="inline-block bg-red text-white px-7 py-4 rounded-[2px] font-sans text-[15px] font-bold hover:bg-red-dark transition-colors text-center"
              >
                Request a Free Estimate
              </Link>
              <Link
                to="/contact"
                className="inline-block border-[1.5px] border-charcoal text-charcoal px-7 py-4 rounded-[2px] font-sans text-[15px] font-bold hover:bg-charcoal/5 transition-colors text-center"
              >
                Visit Our Showroom
              </Link>
            </div>
      ...
      <section className="bg-subtle border-t border-border py-20">
        <div className="max-w-[1180px] mx-auto px-6">
          <p className="font-sans text-[10px] font-semibold text-walnut uppercase tracking-[0.16em] mb-4">
            Material Overview
          </p>
          <h2 className="font-serif text-[30px] lg:text-[40px] font-bold text-charcoal leading-tight mb-12">
            Four Materials, Four Different Answers
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {cards.map(({ label, title, desc, bestFor, facts, Illustration }) => (
              <article
                key={title}
                className="bg-[#FFFDFA] border border-[#DDD4C6] rounded-[3px] p-6 flex flex-col"
              >
                <p className="font-sans text-[9px] font-semibold text-walnut uppercase tracking-[0.14em] mb-5">
                  {label}
                </p>
                <div className="mb-6 flex items-center justify-center h-[100px]">
                  <Illustration />
                </div>
                <h3 className="font-serif text-[20px] font-bold text-charcoal mb-3 leading-tight">
                  {title}
                </h3>
                <p className="font-sans text-[13px] text-[#111D27] leading-relaxed mb-5 flex-1">
                  {desc}
                </p>
                <div className="mb-5">
                  <span className="inline-block font-sans text-[11px] font-semibold text-[#6B4423] border border-[#C89B62] px-2.5 py-1 rounded-[2px]">
                    Best for: {bestFor}
                  </span>
                </div>
                <ul className="flex flex-col gap-1.5 border-t border-[#DDD4C6] pt-4">
                  {facts.map((f) => (
                    <li key={f} className="font-sans text-[12px] text-charcoal/55 flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-[#C89B62] shrink-0" aria-hidden="true" />
                      {f}
                    </li>
                  ))}
                </ul>
      ...
      <section className="bg-ivory border-t border-border py-20">
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <h2 className="font-serif text-[30px] lg:text-[40px] font-bold text-charcoal leading-tight mb-10">
            ...
            <table className="w-full min-w-[600px] border-collapse text-left">
              <thead>
                <tr className="bg-charcoal">
                  <th className="px-4 py-4 font-sans text-[12px] font-semibold text-ivory/70 uppercase tracking-wide border-b border-charcoal w-[22%]">
                    Feature
                  </th>
                  {['Hardwood', 'Engineered Wood', 'Laminate', 'Vinyl (LVP/LVT)'].map((col) => (
                    <th key={col} className="px-4 py-4 font-sans text-[13px] font-bold text-[#FFFDFA] border-b border-charcoal">
                      {col}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {tableRows.map((row, ri) => {
                  ...
                  return (
                    <tr key={row.label}>
                      <td className={`${rowBg} px-4 py-4 font-sans text-[13px] font-semibold text-charcoal border-b border-[#DDD4C6]`}>
                        {row.label}
                      </td>
                      {row.cells.map((cell, ci) => (
                        <TableCell key={ci} cell={cell} isAlt={isAlt} />
                      ))}
                    </tr>
                  );
                })}
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {callouts.map(({ heading, body }) => (
              <div
                key={heading}
                className="bg-[#F1E4D2] border-l-[3px] border-[#C89B62] px-7 py-6 rounded-r-[2px]"
              >
                <h3 className="font-serif text-[18px] font-bold text-charcoal mb-3 leading-snug">
                  {heading}
                </h3>
                <p className="font-sans text-[14px] text-[#111D27] leading-relaxed">
                  {body}
                </p>
              </div>
            ))}
      ...
      <section className="bg-charcoal py-24">
        <div className="max-w-[720px] mx-auto px-6 text-center">
          <h2 className="font-serif text-[28px] lg:text-[44px] font-bold text-ivory leading-tight mb-5">
            Still Not Sure Which Flooring Is Right for You?
          </h2>
          <p className="font-sans text-base text-[#E4DED4] leading-relaxed mb-9">
            Visit our Burbank showroom or schedule a project consultation. We&rsquo;ll help you compare suitable options based on your property, lifestyle, and budget.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              ...
              className="inline-block border border-ivory/30 text-ivory px-7 py-4 rounded-[2px] font-sans text-[15px] font-bold hover:border-ivory/60 hover:bg-ivory/5 transition-colors text-center"
            >
              Call Now — (818) 515-0009
            </a>
          </div>
        </div>
      </section>
